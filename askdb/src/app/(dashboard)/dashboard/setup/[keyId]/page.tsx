...
export default function SetupPage() {
  ...
  if (!keyInfo) {
    return <p className="text-muted-foreground">API key not found.</p>;
  }
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            Replace <code>&lt;YOUR_API_KEY&gt;</code> in the configs below with
            your full API key (shown once at creation).
          </p>
        </CardContent>
      </Card>
